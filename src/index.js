...
import { domOn, domForEach } from './lib/dom.js'

import renderArtistsSection from './sections/artists.js'
import { renderSongsSection, renderSearchSongsSection, renderFavoritesSongsSection } from './sections/songs.js'
import renderLyricsSection from './sections/lyrics.js'

// On les importe au moins une fois dans l'index, pour être sûr que les eventlisteners seront appelés
import './sections/player.js'
