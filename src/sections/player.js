...
// Song infos
const playerThumbnails = document.querySelectorAll('.player-thumbnail-image')
...
// On créé une fonction pour exposer le changement de liste de chansons
...
function playSong(song, songs) {
    ...
    for (const playerThumbnail of playerThumbnails) {
...
//imagePrev.addEventListener('click', playPreviousSong)

// Bouton suivant
playerNext.addEventListener('click', playNextSong)
//imageNext.addEventListener('click', playNextSong)
